  ...
  <div>
    ...
    <section class="about">
      <div class="container" id="about">
        ...
        <div class="about-container">
          <h2>USEI</h2>
          <h2>Bienvenido Administrador!! Gestiona diferentes funcionalidades como ser la principales certificados, encuestas, estudiantes, noticias y datos. <b>Universidad Catolica Boliviana</b></h2>
        </div>
        <div class="clear"></div>
      </div>
    </section>
