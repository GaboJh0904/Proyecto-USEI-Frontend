<template>
    <div>
      ...
      <main class="student-survey-container">
        ...
        <!-- Reemplazo del gráfico de barras por una tabla -->
        <div class="charts-container">
            ...
            <div class="table-container">
                ...
                <tbody>
                    <tr v-for="(carrera, index) in carrerasData" :key="index">
  ...
  export default {
    ...
    data() {
      return {
        ...
        // Datos estáticos de ejemplo para la tabla
        carrerasData: [
        { nombre: "Ingeniería de Sistemas", cantidad: 120 },
        { nombre: "Derecho", cantidad: 85 },
        { nombre: "Medicina", cantidad: 150 },
        ],
